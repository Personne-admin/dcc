...
export TOPLEVEL BUILD_DIR OBJ_DIR PCM_DIR DEP_DIR NATIVE_BUILD_DIR PREFIX DESTDIR CROSS DCC_INSTALL_PREFIX
export ENABLE_LLVM ENABLE_ASAN BUILD_TYPE
export BINDIR LIBDIR INCLUDEDIR DOCDIR DCC_VERSION
