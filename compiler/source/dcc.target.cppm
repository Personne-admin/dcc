...
export namespace dcc::target
{
    ...
    [[nodiscard]] std::string_view register_family(std::string_view name)
    {
        static constexpr std::string_view gprs[][5] = {
            {"rax", "eax", "ax", "al", "ah"},    {"rcx", "ecx", "cx", "cl", "ch"},    {"rdx", "edx", "dx", "dl", "dh"},    {"rbx", "ebx", "bx", "bl", "bh"},
